...
- [x] Workspace exists (`/workspace/agent-session-authority`)
...
AUTH-01 / AUTH-03 / AUTH-05 / AUTH-06 checkers and handwritten corpus landed earlier (ahead of schedule). AUTH-02 / AUTH-04 / AUTH-07 remain `not_tested` stubs (Week-2). Day 3–4 work hardens the history + CLI substrate those checkers already consume.
